import sys
sys.path.append('/home/niccolo/ExamodePipeline/StainNet-master/')
import torch
...
parser.add_argument('-t', '--TASK', help='task (binary/multilabel)',type=str, default='StainNet')
...
if (TASK=='StainNet'):
	...
	try:
		...
		for i in range(len(missing)):
			state_dict[missing[i]] = state_dict.pop(unexpected[i])
		# end fix
